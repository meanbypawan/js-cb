...
function displayCart(){
  ...
  rightColDiv.setAttribute("class","col-md-3 offset-1 d-flex align-items-center justify-content-center");
...
function placeOrder(){
  ...
  var currentUser = sessionStorage.getItem("currentUser"); // "Shivam"
